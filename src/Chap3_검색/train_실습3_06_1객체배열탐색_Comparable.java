...
class Fruit5 implements Comparable<Fruit5>{
	private String name;
	private int price;
	private String date;
	
	Fruit5(String name, int price, String date) {
		this.name = name;
		this.price=price;
		this.date=date;
	}
	...
	public int compareTo(Fruit5 b) {
		return this.price - b.price;
	}
}

class Fruit5Name implements Comparator<Fruit5>{
