...
public class train_실습5_8_QueenPlacement_구현실습과제 {

	int numberOfSolutions = 0;
	int count = 0;// 퀸 배치 갯수
	int ix = 0, iy = 0;// 행 ix, 열 iy
	Stack st = new Stack(100); // 100개를 저장할 수 있는 스택을 만들고
...
public static boolean checkMove(int[][] d, int x, int y) {// (x,y)로 이동 가능한지를 check
	if(checkRow(d,x) || checkCol(d,y) || checkDiagSW(d,x,y) || checkDiagSE(d,x,y)) {return false;}
	//else {return true;}
	return true;
}
