...
class Queue {
	...
	private int num;//큐 내의 현재 데이터 개수
	//private boolean isEmptyTag; //큐가 가득찼는지
...
public class train_실습4_3_1정수선형큐_리스트 {
	public static void main(String[] args) {
		...
		Queue oq = new Queue(4); // 최대 64개를 인큐할 수 있는 큐
		...
		while (true) {
			...
			case 1: // 인큐
				...
				try {
					oq.enque(rndx);
				} catch(Chap4_스택과큐.Queue.OverflowQueueException e) {
			...
			case 2: // 디큐
				...
				} catch (Chap4_스택과큐.Queue.EmptyQueueException e) {
