...
public class Test06 {
	...
	public static void main(String[] args) {
		...
		while(keys.hasNext()) {
			...
			System.out.println(String.format("방법1 %s : %s", key, dic.get(key)));
		}
		
		//방법2
		for(Map.Entry<String, String> elem : dic.entrySet()) {
			System.out.println(String.format("방법2 %s : %s", elem.getKey(), elem.getValue()));
		}
		
		//방법3
		for(String key : dic.keySet()) {
			System.out.println(String.format("방법3 %s : %s", key, dic.get(key)));
		}
