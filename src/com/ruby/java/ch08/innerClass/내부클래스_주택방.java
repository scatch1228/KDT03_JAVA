...
class House {
	...
	private Room[] rooms;
	private int numRooms;//array length
	private int count;//counting rooms
...
public class 내부클래스_주택방 {
	public static void main(String[] args) {
		...
		myRoom.show();
		myHouse.show();
		com.ruby.java.ch08.innerClass.House.Room x = myHouse.getRooms()[0];
		x.show();
		
		com.ruby.java.ch08.innerClass.House.Room y = myHouse.getRooms()[1];
		y.show();
	}
}