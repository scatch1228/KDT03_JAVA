 ...
 */
    ...
    public static String[] convertValuesToString(boolean boolVal, char charVal, double doubleVal, int intVal, float floatVal) {
    	...
    	stringArray[0]=String.valueOf(boolVal);
    	stringArray[1]=String.valueOf(charVal);
    	stringArray[2]=String.valueOf(doubleVal);
    	stringArray[3]=String.valueOf(intVal);
    	stringArray[4]=String.valueOf(floatVal);
